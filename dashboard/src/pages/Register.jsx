  ...
  const handleRegister = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://my-protfolio-backend-oy2q.onrender.com/api/v1/user/register",
        formData,
        {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-10 flex justify-center">
      ...
      >
        ...
        <input
          type="text"
          placeholder="Portfolio URL (Put any URL for now)"
          value={portfolioURL}
        ...
        <button type="submit" className="bg-green-600 p-2 font-bold">
          Register
        </button>
      </form>
    </div>
