      ...
      <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
            ...
            <p className="text-gray-400 mb-8 text-lg">
                Have a project or opportunity in mind or just want to say Something? I'm always open to discussing in New Ideas.
            </p>

            <div className="space-y-6">
                {/* Glassy Icon Boxes */}
                <ContactInfoBox icon={<Mail />} text="biranchinarayanpanda52@gmail.com" color="text-blue-400" bgColor="bg-blue-500/10" borderColor="border-blue-500/20" />
                <ContactInfoBox icon={<Phone />} text="+91 8114844473" color="text-purple-400" bgColor="bg-purple-500/10" borderColor="border-purple-500/20" />
                <ContactInfoBox icon={<MapPin />} text="Odisha, India" color="text-pink-400" bgColor="bg-pink-500/10" borderColor="border-pink-500/20" />
            </div>
        </motion.div>
