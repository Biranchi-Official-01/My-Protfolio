    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 z-10 w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            >
                <SocialIcon href="https://github.com/Biranchi-Official-01" icon={<Github size={22} />} color="hover:text-white hover:shadow-[0_0_15px_white]" />
                <SocialIcon href="https://www.linkedin.com/in/biranchinarayanpanda898404" icon={<Linkedin size={22} />} color="hover:text-blue-500 hover:shadow-[0_0_15px_#3b82f6]" />
                <SocialIcon href="https://www.instagram.com/_invincible_official_01/" icon={<Instagram size={22} />} color="hover:text-pink-500 hover:shadow-[0_0_15px_#ec4899]" />
                <SocialIcon href="https://x.com/biranchi_8984" icon={<Twitter size={22} />} color="hover:text-blue-400 hover:shadow-[0_0_15px_#60a5fa]" />
            </motion.div>
